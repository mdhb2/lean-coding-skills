...
- Save investigation notes and proposed fix plan under `.lcs/docs/<timestamp>-<slug-work-item>/debug.md` and update `.lcs/state.md`.
...
- Once understood, write proposed hypotheses and quick investigation plan to `.lcs/docs/<timestamp>-<slug-work-item>/debug.md`.
...
Next file to read: .lcs/docs/<timestamp>-<slug-work-item>/debug.md
Current phase: debug
